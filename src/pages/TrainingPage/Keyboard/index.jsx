  ...
  return (
    <div className="keyboard">
      ...
      <div className="row row-3">
        ...
        <div className='key special-key' id="Enter">Enter</div>
      </div>
      <div className="row row-4">
        <div className={getLeftShiftClassName()} id="ShiftLeft">Shift</div>
        ...
        <div className={getRightShiftClassName ()} id="ShiftRight">Shift</div>
      </div>
